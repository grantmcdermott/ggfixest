...
Multiple confidence interval levels are supported, but the `geom_style` argument
should be set to either "errorbar" or "ribbon" for these to be clearly visible. 
(The "pointrange" default doesn't make the differences clear.)
