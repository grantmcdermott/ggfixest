...
[event study](https://theeffectbook.net/ch-EventStudies.html) plots) with
...
The [package website]([introductory vignette](http://grantmcdermott.com/ggiplot)
...
**ggiplot** _only_ supports **fixest** model objects, so the latter must be 
loaded alongside the former.
...
detailed [vignette](http://grantmcdermott.com/ggiplot/articles/ggiplot.html) on
