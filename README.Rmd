...
function. The goal of **ggiplot** is to produce nice
[event study](https://theeffectbook.net/ch-EventStudies.html) plots with minimal
effort, but with lots of scope for further customization.
